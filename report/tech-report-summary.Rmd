...
The workshop leaders provided prototype code to help kickstart the subgroup explorations at <https://github.com/TESA-workshops/sim-geostat-survey>.
...
Challenges included the limited amount of time for the project (\~ 6 hours), the virtual setting, challenges for users working with packages that they were not yet familiar with, computational demands give in the limited time, and visualizing and summarizing high-dimensional results.
